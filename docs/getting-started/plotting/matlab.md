...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/plot.png" alt="Figure 1: plot"></div>This can work for any field of length `md.mesh.numberofelements` or `md.mesh.numberofvertices`.
### Options
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/caxis.png" alt="Figure 2: caxis"></div>
#### colorbar
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/colormap.png" alt="Figure 3: colormap"></div>
#### log
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/log.png" alt="Figure 4: log"></div>
#### contourlevels
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/contour3.png" alt="Figure 5: contour3"></div>````
>> plotmodel(md, 'data', md.vel, 'contourlevels', {100, 200, 500, 1000, 2000, 2500})
````

<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/contourcell.png" alt="Figure 6: contourcell"></div>
#### contourticks
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/contourticks.png" alt="Figure 7: contourticks"></div>
#### contouronly
...
<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/streamlines50.png" alt="Figure 8: streamlines50"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/streamlinescell.png" alt="Figure 8: streamlinescell"></div>
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/edgecolor.png" alt="Figure 9: edgecolor"></div>
#### expdisp
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/mask.png" alt="Figure 10: mask"></div>
#### northarrow
...
<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/basaldrag.png" alt="Figure 11: basaldrag"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/basaldragcomp.png" alt="Figure 11: basaldragcomp"></div><span style="display:block;width:100%;text-align:center"><small>Basal friction norm and Basal friction x-component</small></span>
#### BC
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/BC.png" alt="Figure 12: BC"></div>#### driving\_stress
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/driving_stress.png" alt="Figure 13: driving_stress"></div>#### elementnumbering
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/elementnumbering.png" alt="Figure 14: elementnumbering"></div>A given list of elements can be highlighted with the `'highlight'` option:
````
>> plotmodel(md, 'data', 'elementnumbering', 'highlight', [3 4 5 6 7])
````

<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/elementnumbering_highlight.png" alt="Figure 15: elementnumbering_highlight"></div>#### elements\_type
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/elements_type.png" alt="Figure 16: elements_type"></div>#### vertexnumbering
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/gridnumbering.png" alt="Figure 17: gridnumbering"></div>
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/gridnumbering_highlight.png" alt="Figure 18: gridnumbering_highlight"></div>#### highlightelements
...
<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/highlightelements_highlight.png" alt="Figure 19: highlightelements_highlight"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/highlightelements_highlight3d.png" alt="Figure 19: highlightelements_highlight3d"></div>#### highlightgrids
...
<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/highlightgrids_highlight.png" alt="Figure 20: highlightgrids_highlight"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/highlightgrids_highlight3d.png" alt="Figure 20: highlightgrids_highlight3d"></div>#### icefront
...
<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/icefront2d.png" alt="Figure 21: icefront2d"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/icefront3d.png" alt="Figure 21: icefront3d"></div>#### mesh
The special plot `'mesh'` displays the mesh of 2D or 3D model:
````
>> plotmodel(md, 'data', 'mesh')
````

<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/mesh2d.png" alt="Figure 22: mesh2d"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/mesh3d.png" alt="Figure 22: mesh3d"></div>### Quiver plot
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/plotquiver.png" alt="Figure 23: plotquiver"></div>
#### ColorLevels
...
<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/color3.png" alt="Figure 24: color3"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/color100.png" alt="Figure 24: color100"></div>````
>> plotmodel(md, 'data', [md.vx md.vy], 'colorlevels', {100, 200, 500, 1000, 2000, 2500})
````

<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/colorcell.png" alt="Figure 25: colorcell"></div>
#### Scaling
...
<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/scaling1.png" alt="Figure 26: scaling1"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/scaling01.png" alt="Figure 26: scaling01"></div>
#### Autoscale
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/autoscale.png" alt="Figure 27: autoscale"></div>
#### Density
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/density3.png" alt="Figure 28: density3"></div>### Cross section
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/track.png" alt="Figure 29: track"></div>````
>> plotmodel(md, 'data', md.vel, 'sectionvalue', 'track.exp')
````

<div style="display:flow-root"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/2d.png" alt="Figure 30: 2d"><img style="float:left;width:50.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/3d.png" alt="Figure 30: 3d"></div><span style="display:block;width:100%;text-align:center"><small>Section plot for 2D (left) and 3D (right) models</small></span>
#### Resolution
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/getting-started/plotting/matlab/show.png" alt="Figure 31: show"></div>
