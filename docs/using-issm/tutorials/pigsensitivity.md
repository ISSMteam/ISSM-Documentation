...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/using-issm/tutorials/pigsensitivity/ResultsTransient.png" alt="Figure 1: ResultsTransient"></div>### Increased basal melting rate
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/using-issm/tutorials/pigsensitivity/ResultsHighMelt.png" alt="Figure 2: ResultsHighMelt"></div>### Retreat of ice front position
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/using-issm/tutorials/pigsensitivity/ResultsFrontRetreat.png" alt="Figure 3: ResultsFrontRetreat"></div>### Change in surface mass balance
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/using-issm/tutorials/pigsensitivity/ResultsSMB.png" alt="Figure 4: ResultsSMB"></div>### Evolution of the ice volume above flotation
...
<div style="display:flow-root"><img style="float:left;width:100.00%" src="/ISSM-Documentation/assets/img/using-issm/tutorials/pigsensitivity/EvolutionVAF.png" alt="Figure 5: EvolutionVAF"></div>
