...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/plot.png" alt="Figure 1: plot"></div>This can work for any field of length `md.mesh.numberofelements` or `md.mesh.numberofvertices`.
### Options
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/caxis.png" alt="Figure 2: caxis"></div>
#### colorbar
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/colormap.png" alt="Figure 3: colormap"></div>
#### log
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/log.png" alt="Figure 4: log"></div>
#### contourlevels
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/contour3.png" alt="Figure 5: contour3"></div>```m
>> plotmodel(md, 'data', md.vel, 'contourlevels', {100, 200, 500, 1000, 2000, 2500})
```

<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/contourcell.png" alt="Figure 6: contourcell"></div>
#### contourticks
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/contourticks.png" alt="Figure 7: contourticks"></div>
#### contouronly
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/edgecolor.png" alt="Figure 9: edgecolor"></div>
#### expdisp
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/mask.png" alt="Figure 10: mask"></div>
#### northarrow
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/BC.png" alt="Figure 12: BC"></div>#### driving\_stress
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/driving_stress.png" alt="Figure 13: driving_stress"></div>#### elementnumbering
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/elementnumbering.png" alt="Figure 14: elementnumbering"></div>A given list of elements can be highlighted with the `'highlight'` option:
```m
>> plotmodel(md, 'data', 'elementnumbering', 'highlight', [3 4 5 6 7])
```

<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/elementnumbering_highlight.png" alt="Figure 15: elementnumbering_highlight"></div>#### elements\_type
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/elements_type.png" alt="Figure 16: elements_type"></div>#### vertexnumbering
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/gridnumbering.png" alt="Figure 17: gridnumbering"></div>
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/gridnumbering_highlight.png" alt="Figure 18: gridnumbering_highlight"></div>#### highlightelements
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/plotquiver.png" alt="Figure 23: plotquiver"></div>
#### ColorLevels
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/colorcell.png" alt="Figure 25: colorcell"></div>
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/autoscale.png" alt="Figure 27: autoscale"></div>
#### Density
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/density3.png" alt="Figure 28: density3"></div>
### Cross section
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/track.png" alt="Figure 29: track"></div>
```m
...
<div style="display:flow-root"><img style="float:left;" src="/ISSM-Documentation/assets/img/docs/getting-started/plotting/matlab/show.png" alt="Figure 31: show"></div>
