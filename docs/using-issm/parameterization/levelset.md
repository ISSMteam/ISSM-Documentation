---
title: Level Set (Ice Front Migration)
layout: default
parent: Parameterization
math: mathjax3
---

## Level Set (Ice Front Migration)
### Physical basis
...
where $${\bf v_f}$$ is the frontal migration velocity, obtained by combining the horizontal ice velocity $${\bf v}$$ with the calving rate $$c$$ (see the <a href="calving">Calving</a> page) and the frontal melt rate $$m$$, both acting outward, normal to the front:
...
````
You must also select a calving law (see the <a href="calving">Calving</a> page) and, if applicable, a frontal melt/undercutting parameterization (`md.frontalforcings`):
````
