...
- $$\kappa$$ is the specific heat conductivity, which can depend on the heat density
...
$$
\mathfrak{D} = \frac{h}{2}\left(\begin{array}{ccc}\left|vx\right| & 0 & 0\\\\0 & \left|vy\right| & 0 \\\\0 & 0 & \left|vz\right|\end{array}\right)
$$
...
- `md.basalforcings.geothermalflux`: geothermal heat flux (in $$\mbox{W}/\mbox{m}^2$$)
